...
private:
	 ...
	 * Devuelve true si todo va bien, false soi encuentra algún error de parseo.
	 *
	 ...
	 */
	static bool _parseObject(const sol::object& obj, const std::string& clave, Properties& props, const std::string& componentName);
