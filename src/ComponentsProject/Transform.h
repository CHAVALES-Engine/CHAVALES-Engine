...
public:
	...
	void setLocalPosition(core::Vector3<> lp);

	void setGlobalRotation(core::Quaternion<> gr);
	void setLocalRotation(core::Quaternion<> lr);

	void setGlobalScale(core::Vector3<> gs);
	void setLocalScale(core::Vector3<> ls);
