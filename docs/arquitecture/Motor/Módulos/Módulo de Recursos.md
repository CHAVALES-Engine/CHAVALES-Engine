...
El módulo de recursos mappeara las ids internas de los recursos con un nombre (string) asociado, una vez cargado el juego el módulo de recursos recorre recursivamente la carpeta de assets mappeando las rutas a los ficheros con su id asociada.
